...
──██────▐█▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓█▌       \
  ...
  function queryAndSendDankMeme(m, meme) {
    var memeUrl = uri.serialize(uri.parse("http://knowyourmeme.com/memes/"+meme+"/photos"));
    request.get(memeUrl).type('text/html').end((error, res) => {
